    ...
    for i in tqdm(range(NUM)):
        ...
        if save_gif:
            ...
            # --- Create and save the main diagnostic figure (and GIF frame) ---
                ...
                im1 = ax1.imshow(potential_2D/(h/cst), extent=[x[0], x[-1], y[0], y[-1]], cmap='viridis', origin='lower')
                ...
                im3 = ax3.imshow(uf_shifted_abs[int(0.375*N):int(0.625*N),int(0.375*N):int(0.625*N)],
